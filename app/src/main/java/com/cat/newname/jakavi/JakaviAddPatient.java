...
public class JakaviAddPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPatient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (hospital.getText().equals("Hospital") || doctor.getText().equals("Doctor") || category.getText().equals("Category") || product.getText().equals("Product")) {
                    Toast.makeText(JakaviAddPatient.this, "Please Fill All Fields", Toast.LENGTH_SHORT).show();
                } else {
                    addPatient();
                }
        ...
        allpatients.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getBaseContext(), JakaviAllPatients.class);
                startActivity(i);
            }
        });
        ...
        doctor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (hospital.getText().equals("Hospital")) {
                    Toast.makeText(JakaviAddPatient.this, "Please Choose Hospital first", Toast.LENGTH_SHORT).show();
                } else {
        ...
        product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (category.getText().equals("Category")) {
                    Toast.makeText(JakaviAddPatient.this, "Please Choose Category first", Toast.LENGTH_SHORT).show();
                } else {
        ...
        dose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (product.getText().equals("Product")) {
                    Toast.makeText(JakaviAddPatient.this, "Please Choose Product first", Toast.LENGTH_SHORT).show();
                } else {
...
//                dialog.dismiss();
    ...
    private void initHospitalsSpinner() {
        ...
        hospitalsSpinner = new SpinnerDialog(JakaviAddPatient.this, prepareHospitalsStringList(hospitals), "Select Hospital", "");// With No Animation
    ...
    private void initDoctorsSpinner(ArrayList<String> list) {
        ...
        doctorsSpinner = new SpinnerDialog(JakaviAddPatient.this, list, "Select Doctor", "");// With No Animation
    ...
    private void initCategoriesSpinner() {
        ...
        categoriesSpinner = new SpinnerDialog(JakaviAddPatient.this, prepareCategoriesStringList(categories), "Select Category", "");// With No Animation
    ...
    private void initProductsSpinner(ArrayList<String> list) {
        ...
        productsSpinner = new SpinnerDialog(JakaviAddPatient.this, prepareProductsStringList(products), "Select Product", "");// With No Animation
    ...
    private void initDosesSpinner(ArrayList<String> list) {
        ...
        dosesSpinner = new SpinnerDialog(JakaviAddPatient.this, list, "Select Dose", "");// With No Animation
