...
import com.cat.newname.dialogs.RevoladeEditDoseDialog;
...
public class RevoladeAllPatients extends AppCompatActivity implements RecyclerTouchListener.RecyclerTouchListenerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revolade_all_patients);
    ...
    private void initDoctorsSpinner() {
        spinnerDialog = new SpinnerDialog(RevoladeAllPatients.this, doctorsNames, "Select Doctor", "");// With No Animation
//        spinnerDialog=new SpinnerDialog(JakaviAllPatients.this,items,"Select or Search City",R.style.DialogAnimations_SmileWindow,"Close Button Text");// With 	Animation
    ...
    public void showDialog(String productId, String patientId, int postition) {
        ...
        DialogFragment dialogFragment = new RevoladeEditDoseDialog(productId, patientId, postition);
        ...
        myInterface.getPatientOfDoctorByPage(drId, pageNum).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (state == 0) {
                        Toast.makeText(RevoladeAllPatients.this, responseObject.getString("data"), Toast.LENGTH_SHORT).show();
                    } else {
